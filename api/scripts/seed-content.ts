...
export const TEMPLATES: Template[] = [
  {
    ...
    slots: ['cycleDay', 'phase'],
    status: 'active',
    order: 0,
  },
  {
    id: 'signal_overrides_phase',
    rung: 'pattern',
    mode: 'cycle',
    state: 'home_e',
    confidence: 'plain',
  ...
  },
  {
    ...
    line2:
      'Based on your last three cycles. Confidence is moderate — cycle lengths varied by four days.',
    line3: 'Two more logged cycles would narrow this estimate.',
    actions: ['View window details'],
    slots: ['cycleDay'],
    status: 'active',
    order: 9,
  },
  {
    id: 'pregnancy_appointment',
    rung: 'milestone',
    mode: 'pregnancy',
    state: 'home_preg',
    confidence: 'plain',
  ...
  },
  {
    ...
    actions: ['Prepare questions'],
    slots: ['postpartumDay', 'appointmentAt'],
    status: 'active',
    order: 12,
  },
  {
    ...
    actions: ['View support resources'],
    slots: [],
    status: 'active',
    order: 13,
  },
